    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playaudio.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                MediaPlayer mediaPlayer = MediaPlayer.create(Family_Members_Activity.this,word.getAudioResourceId());
                mediaPlayer.start();
            }
        });
...
//        listView.setBackgroundColor(Color.parseColor(color));
        // this fills color in the background
        // the app looks similar but it is not by this
    }
}